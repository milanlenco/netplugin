...
parser.add_argument("-driver", default='ovs', help="dataplane driver (i.e ovs, vpp)")
...
testbed = api.tbed.Testbed(addrList, args.user, args.password, args.binpath, args.plugintype, args.driver)
