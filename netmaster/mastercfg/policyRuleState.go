...
func addPolicyRuleState(vppRule *govpp.VppnetPolicyRule) error {
	ruleCfg := &CfgPolicyRule{}
	ruleCfg.StateDriver = stateStore
	ruleCfg.VppnetPolicyRule = (*vppRule)
...
func delPolicyRuleState(vppRule *govpp.VppnetPolicyRule) error {
	ruleCfg := &CfgPolicyRule{}
	ruleCfg.StateDriver = stateStore
	ruleCfg.VppnetPolicyRule = (*vppRule)
