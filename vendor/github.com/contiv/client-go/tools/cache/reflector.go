...
import (
	...
	apierrs "github.com/contiv/client-go/pkg/api/errors"
...
func trimPackagePrefix(file string) string {
	if l := strings.LastIndex(file, "github.com/contiv/client-go/pkg/"); l >= 0 {
		return file[l+len("github.com/contiv/client-go/"):]
	}
